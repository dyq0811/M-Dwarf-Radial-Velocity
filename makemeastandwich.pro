...
pro makemeastandwich
  ...
  file = "/NFSMounts/Olin304HomeMount/dingy/idl_lib/tellrv_new/spec/J0727+0513.fits" 
  std0 = MRDFITS(file,0,shdr)

  file_tc = "/NFSMounts/Olin304HomeMount/dingy/idl_lib/tellrv_new/spec/J0727+0513_tc.fits"
  ...
  mwrfits, out, "/NFSMounts/Olin304HomeMount/dingy/idl_lib/tellrv_new/spec/J0727+0513_rest.fits", shdr, /create
stop
end