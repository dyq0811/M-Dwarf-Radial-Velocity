PRO print_gaia_sample, ccorr=ccorr, contf=contf, showplot=showplot
  quiet = 1
  showplot = 0

  atrans = MRDFITS('/home/dingy/Desktop/dingy_07_03/idl_lib/tellrv_new/atrans.fits', 0, silent=quiet)
  READCOL, '/home/dingy/Desktop/dingy_07_03/idl_lib/tellrv_new/104id_both_fits_found_gaia_rv.txt', stars, rvs, skipline=1, format='(A,F)', silent=quiet
